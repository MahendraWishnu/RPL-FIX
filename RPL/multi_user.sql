...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2019 at 01:51 PM
...
--
-- Table structure for table `adminsm`
--

CREATE TABLE `adminsm` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `adminsm`
--

INSERT INTO `adminsm` (`id`, `UserName`, `Password`, `updationDate`) VALUES
...
('TRX00003', 12, '2019-12-07', '2019-12-08', 2, 0, 'Selesai', 'test@gmail.com', 'Ambil Sendiri', '2019-12-04', '04122019103315Capture2.JPG'),
('TRX00004', 10, '2019-12-08', '2019-12-09', 2, 0, 'Cancel', 'test@gmail.com', 'Ambil Sendiri', '2019-12-07', ''),
('TRX00005', 10, '2019-12-08', '2019-12-09', 2, 0, 'Cancel', 'test@gmail.com', 'Ambil Sendiri', '2019-12-07', ''),
('TRX00006', 12, '2019-12-13', '2019-12-13', 1, 450000, 'Cancel', 'test@gmail.com', 'Ambil Sendiri', '2019-12-07', ''),
('TRX00007', 12, '2019-12-13', '2019-12-13', 1, 450000, 'Menunggu Pembayaran', 'test@gmail.com', 'Ambil Sendiri', '2019-12-07', ''),
('TRX00008', 11, '2019-12-28', '2019-12-28', 1, 0, 'Menunggu Pembayaran', 'test@gmail.com', 'Pickup Sesuai Alamat', '2019-12-07', ''),
('TRX00009', 11, '2019-12-12', '2019-12-12', 1, 0, 'Selesai', 'test@gmail.com', 'Ambil Sendiri', '2019-12-08', '08122019013018IMG_72617.jpg');
...
('TRX00003', 12, '2019-12-07', 'Selesai'),
('TRX00003', 12, '2019-12-08', 'Selesai'),
('TRX00004', 10, '2019-12-08', 'Cancel'),
('TRX00004', 10, '2019-12-09', 'Cancel'),
('TRX00005', 10, '2019-12-08', 'Cancel'),
('TRX00005', 10, '2019-12-09', 'Cancel'),
('TRX00006', 12, '2019-12-13', 'Cancel'),
('TRX00007', 12, '2019-12-13', 'Menunggu Pembayaran'),
('TRX00008', 11, '2019-12-28', 'Menunggu Pembayaran'),
('TRX00009', 11, '2019-12-12', 'Selesai');
...
(5, 'Rekening', 'rekening', '																						123456789 Bank BCA a/n AHMAD TEDI DWI PRABOWO'),
...
(16, '97872', 'KD001', 'Mahendra', '0000-00-00', '00:00:00', '00:00:00', 0, 88, 'Pilih Kelas Pesawat', 'Surabaya', '', 0);
...
INSERT INTO `usersm` (`id_user`, `nama_user`, `email`, `password`, `telp`, `alamat`, `ktp`, `kk`, `RegDate`, `UpdationDate`) VALUES
(5, 'Test', 'test@gmail.com', '098f6bcd4621d373cade4e832627b4f6', '0819898989', 'test doang', '04082018212116dashboard.png', '04082018212116belumkembali.png', '2018-08-04 14:21:16', '2019-12-04 03:22:54'),
...
--
-- AUTO_INCREMENT for table `adminsm`
--
ALTER TABLE `adminsm`
...
--
ALTER TABLE `tiket`
  MODIFY `idTiket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT for table `usersm`
--
ALTER TABLE `usersm`
