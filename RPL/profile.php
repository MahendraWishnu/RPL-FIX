...
if(isset($_POST['updateprofile'])){
	...
	$email=$_POST['email'];
	$sql="UPDATE usersm SET nama_user='$name',telp='$mobileno',alamat='$address' WHERE email='$email'";
                                    ...
                                    <nav>
                                        <ul class="top-social-nav">
                                            ...
                                            <li><a href="https://www.youtube.com/channel/UCl-HaWwpTbJyN-5EfFfor8A/featured?view_as=subscriber"
                                                    ...
                                                    target="_blank"><span class="fas fa-address-book"></span></a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
...
$sql = "SELECT * from usersm where email='$useremail'";
$query = mysqli_query($koneksidb,$sql);
